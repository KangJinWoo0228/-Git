...
# =============================================================================
    ...
    if len(idxs) > 0:
        for i in idxs.flatten():
            ...
            cv2Text = cv2.putText(img, text = '%s %.2f %d' % (LABELS[class_ids[i]], confidences[i], w), org=(x, y - 10),
                        fontFace=cv2.FONT_HERSHEY_SIMPLEX, fontScale=1, color=(0, 0, 255), thickness=2)
            cv2Text

            if cv2Text is not None:
                path = "C:/Users/SMHRD/PycharmProjects/Tracer-/pycharmGit/OCR/plate001.jpg"
